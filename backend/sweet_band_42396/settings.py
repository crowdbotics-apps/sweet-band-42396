"""
Django settings for sweet_band_42396 project.
...
ROOT_URLCONF = 'sweet_band_42396.urls'
...
WSGI_APPLICATION = 'sweet_band_42396.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_band_42396 API",
    "DESCRIPTION": "API documentation for sweet_band_42396 App",
    "VERSION": "v1",
}
